			...
			<form action="{{URL::to('save-sign-up-blood')}}" method="POST">
				...
				<div align="center" class="signin__info blood_info--name  d-flex bg-module-middle wow animate__fadeInUp" data-wow-duration="2s">
					...
					<div class="col-md-9 pr-0">
						<select onchange="filterBlood(this)" name="blood_donation_id" class="select2">
							<option value="" class="font-italic">--Chọn đợt hiến máu--</option>
							@foreach($list_blood_donation as $key => $value_blood)
								<option value="{{$value_blood->blood_donation_id}}">{{$value_blood->blood_donation_name}}</option>
							@endforeach
						</select>
						<?php
				...
				<div class="d-flex justify-content-center">
					...
					<div class="form-group row form-group--center wow animate__fadeInUp" data-wow-duration="2s" style="margin: 0">
						...
						<div class="col-lg-12 col-md-12 form-group pl-0 pr-0">
							<button type="submit" class="btn btn-danger d-flex align-items-center justify-content-center" style="width: 100%; background:#FDD835; border: none; height: 45px;border-radius: 45px;" href="#">Đăng Ký</button>
						</div>
					</div>
				</div>
			</form>
...
<script type="text/javascript">
	...
	function filterBlood(obj)
    {
        
        var value = obj.value;
        $.ajax({
                url:"{{URL('/filter-blood')}}",
                method:"POST",
                data:{
                	"_token": "{{ csrf_token() }}",
                	"blood_id":value
                ...
                success:function(response)
                {
                    ...
                    response['response'].forEach(el => {
                        html+=`<div class="blood_info--detail d-flex justify-content-between">
					<div align="center" class="col-md-6 signin__info signin__info--blood d-flex bg-module-middle wow animate__fadeInUp pl-0" data-wow-duration="2s">
						...
						<input type="text" 
							class="form-control display-inline-block" value="${el['place']}" placeholder="">
					</div>
					<div align="center" class="col-md-5 signin__info signin__info--blood d-flex bg-module-middle wow animate__fadeInUp pr-0" data-wow-duration="2s">
						...
						<input type="text" 
							class="form-control display-inline-block" value="${el['object']}" placeholder="">
					</div>
				</div>
				<div class="blood_info--detail d-flex justify-content-between">
					<div align="center" class="col-md-6 signin__info signin__info--blood d-flex bg-module-middle wow animate__fadeInUp pl-0" data-wow-duration="2s">
						...
						<input type="text" 
							class="form-control display-inline-block" value="${el['hospital']}" placeholder="">
					</div>
					<div align="center" class="col-md-5 signin__info signin__info--blood d-flex bg-module-middle wow animate__fadeInUp pr-0" data-wow-duration="2s">
						<label class="col-md-3 text-left d-flex align-items-center">Thời Gian</label>
						<input type="text" 
							class="form-control display-inline-block" value="${el['time']}" placeholder="">
					</div>
				</div>`;
                        
                    });
                    document.getElementById('blodd_info').innerHTML = html;
