          ...
          <table class="table ">
              <tr>
                <td>
                   ...
                   <input type="text" name="blood_donation_name" required="" class="form-control" id="exampleInputEmail1" placeholder="Enter Employee">
                </td>
                <td>
              ...
              <tr>
                <td>
                   ...
                   <input type="time" name="blood_donation_time" required="" class="form-control" id="exampleInputEmail1" placeholder="Enter Employee">
                </td>
                <td>
                  <label for="exampleInputEmail1">Địa Điểm</label>
                  <input type="text" name="blood_donation_place" required="" class="form-control" id="exampleInputEmail1" placeholder="Địa điểm">
                </td>
              </tr>
              <tr>
                <td>
                   <label for="exampleInputEmail1">Đối Tượng</label>
                   <input type="text" name="blood_object" required="" class="form-control" id="exampleInputEmail1" placeholder="Đối tượng">
                </td>
                <td>
                  <label for="exampleInputEmail1">Ngày Tổ Chức</label>
                  <input type="date" name="blood_start_date" required="" class="form-control" id="exampleInputEmail1" placeholder="Enter Employee">
                </td>
              </tr>
              <tr>
                <td>
                  <label for="exampleInputEmail1">Ngày Kết Thúc Đăng Ký</label>
                  <input type="date" name="blood_finish_date" required="" class="form-control" id="exampleInputEmail1" placeholder="Enter Employee">
                </td>
                <td><label for="exampleInputEmail1">Lưu Ý</label>
                  <textarea style="resize:none" rows="5" required="" class="form-control" id="exampleInputPassword1" placeholder="Lưu ý" name="blood_note"></textarea>
                </td>
              </tr>
              <tr>
                <td>
      ...
      <table class="table table-striped table-bordered b-t b-light" id="myTable">
        ...
        <tbody>
          ...
          <tr id="row_{{$bl_value->blood_donation_id}}">
            ...
            <td>
                <a href="{{URL::to('/report-list-blood/'.$bl_value->blood_donation_id)}}" class="btn btn-info" >Danh sách hiến máu</a>
            </td>
          </tr>
          @endforeach 
        </tbody>
