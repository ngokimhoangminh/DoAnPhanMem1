          ...
          <table class="table">
              <tr>
                <td>
                   ...
                   <input type="text" name="employee_name" class="form-control" id="exampleInputEmail1" placeholder="Enter Employee">
                </td>
                <td>
              ...
              <tr>
                <td>
                   ...
                   <input type="text" name="employee_title" class="form-control" id="exampleInputEmail1" placeholder="Enter Employee">
                </td>
                <td>
                  <label for="exampleInputEmail1">Khoa</label>
                  <input type="text" name="employee_department" class="form-control" id="exampleInputEmail1" placeholder="Enter Employee">
                </td>
              </tr>
              <tr>
                <td>
                   <label for="exampleInputEmail1">Số Điện Thoại</label>
                   <input type="text" name="employee_phone" class="form-control" id="exampleInputEmail1" placeholder="Enter Employee">
                </td>
                <td>
                  <label for="exampleInputEmail1">Email</label>
                  <input type="text" name="employee_email" class="form-control" id="exampleInputEmail1" placeholder="Enter Employee">
                </td>
              </tr>
              <tr>
                <td>
