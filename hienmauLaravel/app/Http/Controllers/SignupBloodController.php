...
class SignupBloodController extends Controller
{
    ...
    public function signup_blood()
   {
    	...
    	if($customer_id)
    	{
    		...
    		return view('client.signupBlood.signup_blood')->with(compact('list_blood_donation'));
    	}else
    	{
   ...
   {
   		return view('client.signupBlood.notification_blood');
   }
   public function save_sign_up_blood(Request $request)
   {
        ...
        $signup_blood->signup_blood_bicum=$data['bicum'];
    		...
    		$signup_blood->signup_blood_kinhnguyet=$data['kinhnguyet'];   
    		$signup_blood->signup_blood_sinhcon=$data['sinhcon'];   
    ...
    public function notification()
    {
        ...
        $data=[];
    		...
    		return view('client.signupBlood.notification_status')->with(compact('data'));
    	}else
    	{
    		return Redirect::to('/login')->send();
    	}
